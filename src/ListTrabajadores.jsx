...
const ListTrabajadores = () => {
  ...
  const getTrabajador = async () => {
    const res = await fetch("https://liquidacionesbackend-production.up.railway.app/api/trabajador");
    const data = await res.json();
    setTrabajador(data);
  };

  const getNombres = async () => {
    const res = await fetch("https://liquidacionesbackend-production.up.railway.app/api/trabajador/nombres");
    const data = await res.json();
    console.log(data)
  }
