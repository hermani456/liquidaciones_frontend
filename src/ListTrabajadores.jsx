...
const ListTrabajadores = () => {
  ...
  const getTrabajador = async () => {
    const res = await fetch("https://liquidaciones_backend.railway.internal/api/trabajador");
    const data = await res.json();
    setTrabajador(data);
  };

  const getNombres = async () => {
    const res = await fetch("https://liquidaciones_backend.railway.internal/api/trabajador/nombres");
    const data = await res.json();
    console.log(data)
  }
