...
const Template = ({ trabajador }) => {
  ...
  const sueldoBase = trabajador?.[0]?.sueldo_base || 0;
  ...
  const pagoDiaTrabajado = Math.round(diasTrabajados * valorDia);
  ...
  const valorDia2 = sueldoLiquido / 30;
  const nuevoBase = diasTrabajados * valorDia2;
  console.log("nuevo base", nuevoBase);
